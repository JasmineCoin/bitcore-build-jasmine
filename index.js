...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-jasmine/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-jasmine -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-jasmine -o bitcore-lib-jasmine.js';
    }
